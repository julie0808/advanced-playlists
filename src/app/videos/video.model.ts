export class Video {
  ...
  public tags: {name: string, id: string /*, groupName: string, groupId: number*/}[]; // example: Solo artist
  ...
  constructor(title: string, youtubeId: string, length: string, dateModified: string, tags: {name: string, id: string/*, groupName: string, groupId: number*/}[], artist: string, ytPlaylists: {name: string, id: string, dateAdded: string}[] ) { 
    this.title = title;
